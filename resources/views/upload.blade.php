                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" id="funcao" name="funcao" size="55" maxlength="50" value="{{ old('funcao') }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" id="identidade" name="identidade" size="55" maxlength="50" value="{{ old('identidade') }}" class="form-control"> 
                                </div>
                            </div>

                            <div class="row mb-3">
                                <div class="col-12">
                                    <label for="document" class="form-label">Adicionar Documento:</label></td>
                                    <input type="file" id="document" name="document" size="55" maxlength="50" value="{{ old('document') }}" class="form-control" accept="application/pdf">    
                                </div>
                            </div>
